...
from api.views import (
    ...
    get_object_tourism,
    get_facilities,
    get_recommendation_placement_parks,
)
...
urlpatterns = [
    ...
    path('api/get_recommendation_placement_parks/', get_recommendation_placement_parks, name='get_recommendation_placement_parks'),
]