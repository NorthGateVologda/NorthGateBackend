...
def convert_geometry_coords_from_3857_to_4326(geometry: GeometryField):
    ...
    if geometry.geom_type == 'Point':
        ...
        converted_lat, converted_lon = convert_from_3857_to_4326(coordinates[0], coordinates[1])
        ...
        for coordinate in coordinates:
            converted_lat, converted_lon = convert_from_3857_to_4326(coordinate[0], coordinate[1])
